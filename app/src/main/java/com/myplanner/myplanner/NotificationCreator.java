...
public class NotificationCreator {
    ...
    public static void addNotification(final AlarmManager alarmManager, final int id, final String title, final String body, final int drawableID, final long timeInMills, final Context context) {
